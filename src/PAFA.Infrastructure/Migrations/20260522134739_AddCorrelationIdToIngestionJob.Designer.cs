...
namespace PAFA.Infrastructure.Migrations
{
    ...
    [Migration("20260522134739_AddCorrelationIdToIngestionJob")]
    partial class AddCorrelationIdToIngestionJob
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PAFA.Domain.Entities.ValidationNotification", b =>
                {
                    ...
                    b.HasIndex("IngestionFileId")
                        .HasDatabaseName("ix_val_notif_file");

                    b.HasIndex("SentAt")
                        .HasDatabaseName("ix_val_notif_sent_at");
